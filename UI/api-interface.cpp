...
//					Q_ARG(bool, false));
	...
	{
        return false;//return main->outputHandler->StreamingActive();
	}
	...
	{
        return false;//main->outputHandler->RecordingActive();
	}
	...
	{
        return false;// main->outputHandler->ReplayBufferActive();
	}
